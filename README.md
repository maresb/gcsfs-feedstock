...
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/gcsfs/badges/version.svg)](https://anaconda.org/conda-forge/gcsfs)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/gcsfs/badges/downloads.svg)](https://anaconda.org/conda-forge/gcsfs)
...
Once the `conda-forge` channel has been enabled, `gcsfs` can be installed with:

```
conda install gcsfs
```

It is possible to list all of the versions of `gcsfs` available on your platform with:
